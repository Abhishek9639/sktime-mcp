...
async def list_tools() -> List[Tool]:
    ...
    return [
        ...
        Tool(
            ...
            description="Load data in the background (non-blocking). Returns a job_id for progress tracking via check_job_status. Good for large files or slow queries.",
            inputSchema={
                "type": "object",
                "properties": {
                    "config": {
                        "type": "object",
                        "description": "Data source config, same as load_data_source. Must include 'type' (pandas, sql, file, url).",
                    },
                },
                "required": ["config"],
            },
